...
def test_response_with_next_result():
...
def test_response_without_next_result():
    """Response.next_result should be None if there is no 'continue' attribute"""
    ...
    # validation
    assert response.next_result is None
